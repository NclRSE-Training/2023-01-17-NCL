...
venue: "HDB.1.13 in the Henry Daysh Building"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "Jan <strike>17</strike>, 24 and 31, 2023"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Dr. Jannetta Steyn", "Dr. Tiago Sousa Garcia", "Dave Horsfall", "Stuart Lewis"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Stuart Lewis", "Abdulrahman Dallak"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
